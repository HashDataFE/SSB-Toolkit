...
## DB_SCHEMA_NAME should be set to the database schema that will be used to store the SSB tables
...
export CLIENT_GEN_PATH="/tmp/ssbenchmark"
...
## step 00_compile_ssb
export RUN_COMPILE_SSB="true"

## step 01_gen_data
# To run another SSB with a different BENCH_ROLE using existing tables and data,
